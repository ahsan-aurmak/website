...
export default function RouteError() {
  ...
  let description = "Please refresh the page and try again.";

  if (isChunkError) {
    title = "Refreshing the latest version";
    description = "The site was updated while this page was open. Refresh once to load the latest version.";
  ...
  return (
    <div className="container mx-auto flex min-h-[70vh] max-w-2xl items-center px-4 py-20">
      <div className="w-full rounded-2xl border border-slate-200/80 bg-white/90 p-8 shadow-lg dark:border-slate-800 dark:bg-slate-950/80">
        <div className="mb-3 text-sm font-medium uppercase tracking-[0.24em] text-[#27aae1] dark:text-cyan-400">
          AURMAK
        </div>
