...
export const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      { path: "smart-building-platform", lazy: lazyPage(() => import("./pages/CaseStudyDetail")) },
      { path: "orchestration-management-platform", lazy: lazyPage(() => import("./pages/CaseStudyDetail")) },
      { path: "premium-travel-portal", lazy: lazyPage(() => import("./pages/CaseStudyDetail")) },
      { path: "stealthwatch-educational-portal", lazy: lazyPage(() => import("./pages/CaseStudyDetail")) },
      { path: "it-service-management-platform", lazy: lazyPage(() => import("./pages/CaseStudyDetail")) },
      { path: "carlounge-experience", lazy: lazyPage(() => import("./pages/CaseStudyDetail")) },
      { path: "enterprise-saas-iaas-platform", lazy: lazyPage(() => import("./pages/CaseStudyDetail")) },
      { path: "government-services-portal", lazy: lazyPage(() => import("./pages/CaseStudyDetail")) },
