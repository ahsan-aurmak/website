import { j as e, m as t, L as r } from "./vendor-DehmoSG1.js";
import { H as o, G as i } from "./card-BRaCt4hI.js";
import { B as l } from "./button-YjDqwrec.js";
import { S as c, g as d } from "./seo-Dq-mFtqA.js";
          ...
          children: [
            e.jsx(t.div, {
              ...
              children: e.jsxs("h2", {
                ...
                children: [
                  "Leadership ",
                  e.jsx("span", { className: "text-[#27aae1]", children: "Team" })
                ]
              })
            }),
            e.jsx("div", {
              ...
              children: n.map((a, s) =>
                e.jsx(t.div, {
                  ...
                  whileInView: { opacity: 1, y: 0 },
                  viewport: { once: !0 },
                  transition: { delay: s * .08 },
                  children: e.jsxs(i, {
                    className: "h-full p-8 dark:border-slate-800/70 dark:bg-none dark:bg-slate-900/85 dark:shadow-none",
                    children: [
                      e.jsxs("div", {
                        ...
                        children: [
                          e.jsxs("div", {
                            ...
                            children: [
                              e.jsx("img", {
                                src: a.photo,
                                alt: a.name,
                                className: `rounded-2xl object-cover grayscale transition-all duration-300 hover:grayscale-0 ring-2 ring-slate-700 hover:ring-cyan-500 ${a.name==="Masood Zafar"?"object-top":""}`,
                          ...
                          e.jsxs("div", {
                            ...
                            children: [
                              e.jsx("div", { className: "text-sm uppercase text-slate-500 dark:text-slate-400", style: { letterSpacing: "0.18em" }, children: a.role }),
                              e.jsx("h3", { className: "mt-3 text-3xl font-bold text-slate-900 dark:text-slate-100", children: a.name }),
                              e.jsx("p", { className: "mt-5 max-w-xl text-lg leading-9 text-slate-700 dark:text-slate-300", children: a.bio })
                            ]
                          })
                        ]
                      })
          ...
          children: e.jsxs(t.div, {
            ...
            children: [
              e.jsxs("h2", {
                ...
                children: [
                  "Global Expert ",
                  e.jsx("span", { className: "text-[#27aae1]", children: "Network" })
                ]
              }),
              e.jsxs("div", {
                className: "space-y-5 text-lg leading-relaxed text-[#5f6b8e] dark:text-slate-300",
                children: [
                  e.jsx("p", { children: "Alongside its leadership team, AURMAK works with a global network of specialist engineers, architects, and delivery partners supporting enterprise programmes across infrastructure systems, data platforms, and AI-enabled solutions." }),
                  e.jsx("p", { children: "This model enables AURMAK to assemble the right expertise for each engagement while maintaining disciplined programme oversight and strategic leadership." })
                ]
              })
            ]
          })
      ...
      e.jsx("section", {
        ...
        children: e.jsx("div", {
          ...
          children: e.jsx(t.div, {
            ...
            viewport: { once: !0 },
            children: e.jsxs(i, {
              className: "relative overflow-hidden px-6 py-12 text-center dark:border-slate-800/70 dark:bg-none dark:bg-slate-900/85 dark:shadow-none",
              children: [
                e.jsx("div", { className: "pointer-events-none absolute inset-0 bg-[#27aae1]/6 dark:bg-[#27aae1]/8" }),
                e.jsxs("div", {
                  ...
                  children: [
                    e.jsxs("h2", {
                      ...
                      children: [
                        "Careers at ",
                        e.jsx("span", { className: "text-[#27aae1]", children: "AURMAK" })
                      ]
                    }),
                    e.jsx("p", {
                      className: "mx-auto mb-8 max-w-2xl text-lg text-slate-600 dark:text-slate-400",
                      children: "We design and build technology systems for real operational environments. If you’re motivated by solving complex technical challenges, we’d like to hear from you."
                    }),
                    e.jsx(l, { to: "/careers", size: "large", children: "Explore Opportunities" })
                  ]
                })
              ]
            })
